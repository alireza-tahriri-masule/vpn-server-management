            ...
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center space-x-6">
                    ...
                    <ul class="flex items-center space-x-6 text-sm">
                        <li class="bg-[#353740] px-4 py-2 rounded"><a href="#">Active Accounts</a></li>
                        <li><a href="#">Inactive Accounts</a></li>
                    </ul>
                </div>
                <button class="px-4 py-1 text-white bg-blue-600 rounded-lg hover:bg-blue-500">Create Configuration</button>
            </div>
        </header>
    </div>
