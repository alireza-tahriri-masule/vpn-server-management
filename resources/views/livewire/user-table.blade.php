    ...
    <table class="w-full text-sm text-white border-collapse table-auto">
        ...
        <tbody>
            ...
            <tr class="border-b border-[#353740] {{ $userIndex % 2 != 0 ? 'bg-[#202124]' : 'bg-[#353740]' }} h-full">
                ...
                <td class="px-4 py-2 text-{{ $user->is_active ? 'green' : 'red' }}-500 whitespace-nowrap">
                ...
                <td
                    class="px-4 py-2 text-{{ \Carbon\Carbon::now()->lessThanOrEqualTo($user->trial_end) ? 'green' : 'red' }}-500 whitespace-nowrap">
                    Trial expires on {{
                    \App\Helpers\DateHelper::translateMonthToEnglish(jdate($user->trial_end)->format('%Y/%B/%d')) }}
                </td>
                <td class="px-4 py-2 whitespace-nowrap">
                    <div class="flex items-center h-full space-x-1">
                ...
                <td class="px-4 py-2 whitespace-nowrap">
                    <div class="flex items-center h-full space-x-1">
                        ...
                        <div>{{
                            \App\Helpers\DateHelper::translateMonthToEnglish(jdate($user->subscription_start)->format('%Y/%B/%d'))
                            }}</div>
                    </div>
                </td>
                <td class="px-4 py-2 whitespace-nowrap">
                    <div class="flex items-center h-full space-x-1">
                        ...
                        <div>{{
                            \App\Helpers\DateHelper::translateMonthToEnglish(jdate($user->subscription_end)->format('%Y/%B/%d'))
                            }}</div>
                    </div>
                </td>
