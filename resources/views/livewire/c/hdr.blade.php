<header class="bg-[#202124] rounded-lg m-4 px-8 py-4 flex items-center justify-between">
    <div class="flex items-center justify-between w-full">
        <div class="flex items-center space-x-6">
            ...
            <livewire:c.mnu :menuItems="$menuItems" />
        </div>
        <livewire:c.btn buttonClass="px-4 py-2 text-sm text-white bg-blue-600 rounded-lg hover:bg-blue-500" buttonText="Create Configuration" />
    </div>
</header>
